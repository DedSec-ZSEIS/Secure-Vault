...
export default function Form() {
    ...
    return (
                ...
                <div className="border-gray-500 border-2 rounded-3xl  w-3/5 h-1/2  font-sans scale-110 bg-white text-black md:w-2/5 lg:w-1/3 xl:w-1/4 2xl:w-1/5 dark:bg-black dark:text-white">
                        <h2 className="my-8 text-3xl font-normal flex  justify-center ">Zaloguj się</h2>
